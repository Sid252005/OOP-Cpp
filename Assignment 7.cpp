...
public:
    ...
    BankAccount(std::string name, double initialDeposit) {
        ...
        std::cout << "Creating Account for " << ownerName << " with Initial Deposit: ?" << balance << "\n";
    }
    ...
    void transfer(BankAccount &to, double amount) {
        ...
        withdraw(amount); 
        to.deposit(amount);
        std::cout << "Transferring ?" << amount << " from " << ownerName << " to " << to.ownerName << "\n";
    }
    ...
    void divideBalance(double divisor) {
        ...
        std::cout << "Result of dividing ?" << balance << " by " << divisor << " is ?" << result << "\n";
    }

    
    void display() const {
        std::cout << "Account Holder: " << ownerName << ", Balance: ?" << balance << "\n";
    }
};
